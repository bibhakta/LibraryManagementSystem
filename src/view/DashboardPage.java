...
public class DashboardPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnissuedbook2 = new javax.swing.JButton();
        ...
        btnissuedbook1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/librarymanagementsystem/Vector.png"))); // NOI18N
        ...
        btnissuedbook2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnissuedbook2.setForeground(java.awt.Color.gray);
        btnissuedbook2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/librarymanagementsystem/Vector.png"))); // NOI18N
        btnissuedbook2.setText("Returned");
        btnissuedbook2.setBorder(null);
        btnissuedbook2.setBorderPainted(false);
        btnissuedbook2.setContentAreaFilled(false);
        btnissuedbook2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnissuedbook2MouseClicked(evt);
            }
        });
        btnissuedbook2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnissuedbook2ActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addComponent(btnissuedbook1, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnissuedbook2, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel35.setIcon(new javax.swing.ImageIcon(getClass().getResource("/librarymanagementsystem/Welcome to Dashboard.png"))); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGap(42, 42, 42)
                .addComponent(jLabel35, javax.swing.GroupLayout.PREFERRED_SIZE, 959, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(btnissue, javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel14Layout.createSequentialGroup()
                        .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtissue, javax.swing.GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE)
        ...
        jTabbedPane2.addTab("", new javax.swing.ImageIcon(getClass().getResource("/librarymanagementsystem/Vector.png")), jPanel19); // NOI18N
        ...
        jTabbedPane2.addTab("", new javax.swing.ImageIcon(getClass().getResource("/librarymanagementsystem/Vector.png")), jPanel20); // NOI18N
...
try {
  ...
  public void clearMeBook()
    ...
    private void btnupdate1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdate1ActionPerformed
        ...
        {
            stmt=conn.createStatement();
            String sql = "UPDATE books SET name1='" + txtname7.getText() + "', writer='" + txtwriter.getText() + "', publisher='" + txtpublisher2.getText() + "', publish_year='" + txtpublishdate.getText()+"' WHERE book_id='"+txtID5.getText()+"'";
            stmt.executeUpdate(sql);
            JOptionPane.showMessageDialog(rootPane, "update succesfully");
            refreshTab2();
...
String issueDate = dateFormat.format(txtissue.getDate());
String dueDate = dateFormat.format(txtdue.getDate());
...
try {
    ...
    ResultSet bookResult = statement.executeQuery(bookQuery);
    ...
    if (bookResult.next()) {
        ...
        if (userResult.next()) {
            // Issue the book
            String insertQuery = "INSERT INTO issue VALUES('" + bookId + "','" + userId + "','" + issueDate + "','" + dueDate + "','" + returnBook + "')";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try {
                ...
                String updateQuery = "UPDATE issue SET returnBook='YES' WHERE user_id='" + userId + "' AND book_id='" + bookId + "'";
...
try {
    ...
    while (rs.next()) {
        ...
        model.addRow(new Object[]{user_id, name, book_id, name1, issueDate, dueDate});
    }

    issuetable.setModel(model);
} catch (SQLException e) {
    e.printStackTrace(); // Print the stack trace to see any exceptions that might occur
}
    ...
    private void btnissuedbook2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnissuedbook2MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_btnissuedbook2MouseClicked

    private void btnissuedbook2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnissuedbook2ActionPerformed
...
try {
    ...
    issuetable1.setModel(model);
} catch (SQLException e) {
    e.printStackTrace(); // Print the stack trace to see any exceptions that might occur
}
      
    }//GEN-LAST:event_btnissuedbook2ActionPerformed
...
// Example of how you might have your refresh button's action listener
    ...
    private javax.swing.JButton btnissuedbook2;
